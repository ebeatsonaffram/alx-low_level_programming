...
/**
 * check_elf - Examine whether a file
 *  is an ELF file.
 * @e_ident: this a  pointer to an array containing
...
/**
 * print_magic - display the magic
 *  numbers of an ELF header.
 * @e_ident: A signal to an array containing
 *  the ELF magic numbers.
...
/**
 * print_data - inscribes the data of an ELF header.
 * @e_ident: A index to an array containing the ELF class.
 */
void print_data(unsigned char *e_ident)
{
	printf("  Data:                              ");
